...
public:
	...
	double getLocation(const int& locX,const int& locY)const {return m_matrix.at((locY*m_cols)+locX);}//might not work right???
	double getLocation(const int& loc)const {return m_matrix.at(loc);}
	//setters
